...
<div class="container mx-auto px-4 py-8 space-y-8">
  ...
  <div>
    ...
    <p class="text-muted-foreground mt-2">
      Administrative KPIs including users, packs opened, Jewels spent,
      and pending fulfillment requests. Restricted access.
    </p>
  </div>
      ...
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold mt-2">{kpis.totalUsers.toLocaleString()}</p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold mt-2">
              ...
              <span class="text-sm text-muted-foreground font-normal"> / {kpis.activeUsers30d.toLocaleString()}</span>
            </p>
      ...
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold mt-2">{kpis.totalPacksOpened.toLocaleString()}</p>
          </div>
      ...
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold mt-2">{formatJewels(kpis.totalJewelsSpent)}</p>
          </div>
      ...
      <Card.Content class="p-6">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold mt-2">{formatCurrency(kpis.totalRevenue)}</p>
          </div>
          <div class="p-3 bg-green-500/10 rounded-lg">
          ...
          <Card.Content class="p-6">
            <div class="flex items-center gap-4">
              <div class="p-2 bg-primary/10 rounded-lg">
                <svelte:component this={item.icon} class="size-5 text-primary" />
              </div>
              <div class="flex-1">
        ...
        {:else}
          <div class="space-y-4">
            {#each recentActivity as activity}
              <div class="flex items-start gap-4 pb-4 border-b last:border-0 last:pb-0">
                ...
                {#if activity.value}
                  <div class="text-sm font-semibold {getActivityColor(activity.type)}">
                    {activity.value}
                  </div>
                {/if}
              </div>
